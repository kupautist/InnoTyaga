...
class LocaleRU(Locale):
    greet = ['Здарова',
             ...
             'Чтобы попасть в топ, необходимо зарегистрироваться: /register.\n'
             ]
    ...
    pp = 'Количество полученных протеин поинтов - ' \
        'вес который вы подняли умноженный на коэффицент и поделённый на ваш собсвенный вес. ' \
        'Коэффицент = 70 для жима, 50 для приседа, 164 для подъёма на бицепс и 46 для становой тяги\n' \
        'Для девушек полученное количество умножается на 1.64.\n' \
        'Цешка начинается с 55, бэшка с 70 и ашка с 85'
    gimme_mail = 'Напишите вашу университетскую почту. Например: a.kupriyanov или a.kupriyanov@innopolis.university'
